...
resource "null_resource" "wordpress_setup" {
	...
	provisioner "remote-exec" {
		inline = [
            ...
            "git clone https://github.com/anand1501/multicloud.git",
            ...
            "sudo docker run -dit -e MYSQL_ROOT_PASSWORD=redhat -e MYSQL_USER=anand -e MYSQL_PASSWORD=redhat -e MYSQL_DATABASE=myWordpressDB -p 3306:3306 --name database mysql:5.7",
            "EOF",
